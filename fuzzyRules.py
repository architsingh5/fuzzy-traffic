...
queue_length_curr = ctrl.Antecedent(np.arange(0, 60, 1), "queue_length_curr")
# queue_length_other = ctrl.Antecedent(np.arange(0, 120, 1), "queue_length_other")
max_waiting_time = ctrl.Antecedent(np.arange(0, 121, 1), "max_waiting_time")

green_signal_time = ctrl.Consequent(np.arange(0, 60, 1), "green_signal_time")
...
rule1 = ctrl.Rule(queue_length_curr["low"] & max_waiting_time["low"], green_signal_time["low"])
rule2 = ctrl.Rule(queue_length_curr["low"] & max_waiting_time["med"], green_signal_time["low"])
rule3 = ctrl.Rule(queue_length_curr["low"] & max_waiting_time["high"], green_signal_time["med"])
rule4 = ctrl.Rule(queue_length_curr["med"] & max_waiting_time["low"], green_signal_time["low"])
rule5 = ctrl.Rule(queue_length_curr["med"] & max_waiting_time["med"], green_signal_time["med"])
rule6 = ctrl.Rule(queue_length_curr["med"] & max_waiting_time["high"], green_signal_time["high"])
rule7 = ctrl.Rule(queue_length_curr["high"] & max_waiting_time["low"], green_signal_time["med"])
rule8 = ctrl.Rule(queue_length_curr["high"] & max_waiting_time["med"], green_signal_time["high"])
rule9 = ctrl.Rule(queue_length_curr["high"] & max_waiting_time["high"], green_signal_time["high"])
